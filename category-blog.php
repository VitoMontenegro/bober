                ...
                <?php if (have_posts()) : ?>
                    ...
                    <?php while (have_posts()) :?>
                        ...
                        <div class="blog-slider__item">
                            <a href="<?php the_permalink() ?>" class="blog-slider__item__preview">
                                <img src="<?php the_post_thumbnail_url(); ?>" class="blog-slider__item__preview__img" alt="<?php the_title(); ?>">
                            </a>
                            ...
                            <div class="blog-slider__item__tags">
                                ...
                                <?php } ?>
                            <a href="<?php the_permalink() ?>" class="blog-slider__item__title">
                                <?php the_title(); ?>
                            </a>
                            <div class="blog-slider__item__excerpt"><?php the_excerpt();?></div>
                            <div class="blog-slider__item__time">
                                ...
                                <div class="blog-slider__item__time__minutes"><?php the_field( 'blog-single_minutes');?></div>
                            </div>
                        </div>
