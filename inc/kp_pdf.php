...
if($results || count($results)){
	...
	$html = '
		<div class="logo">
			<a target="_blank" href="https://bober.services/">
				<img class="logo_img" src="https://bober.services/wp-content/themes/bober/images/header-logo.jpg">
			</a>
		</div>
	...
	foreach($arr as $item){
		foreach($item as $k=>$item2){
			...
			if($image[0]){
				...
				$pdf->Image('https://bober.services/wp-content/uploads/woocommerce-placeholder-300x300.png', 25, $pdf->GetY(), 90);
			}
