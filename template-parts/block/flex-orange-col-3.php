<section class="section flex-orange-col-3__section">
    <div class="container">
        ...
        <div class="flex-orange-col-3">
            ...
            <a href="<?php the_sub_field('flex-orange-col-3_item_link');?>" class="flex-orange-col-3__item">
                <?php if(get_sub_field('flex-orange-col-3_item_title')){?>
                <span class="flex-orange-col-3__item__title"><?php the_sub_field('flex-orange-col-3_item_title');?></span>
                <?php } ?>
                ...
                <?php if(get_sub_field('flex-orange-col-3_item_img')){
                    ...
                    <span class="flex-orange-col-3__item__img-wrap">
