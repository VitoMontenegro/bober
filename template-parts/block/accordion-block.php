        ...
        <?php if ($remont_term) : ?>
            ...
            <?php if ($categories) : ?>
                <?php foreach ($categories as $category) : ?>
                    <div class="accordion-price <?php if(isset($_GET['param1']) && $_GET['param1'] ===  $category->slug) echo ' js-accordion-price-item-open' ?>" id="<?php echo $category->slug ?>">
                        ...
                        <div class="accordion-price__content" <?php if(isset($_GET['param1']) && $_GET['param1'] ===  $category->slug) echo ' style="display: block;"' ?>>
                            <?php
            ...
            <?php else: ?>
                <?php if(get_field('accordion-price_option_title')){?>  <!--Стоимость услуг-->
                    <div class="accordion-price js-accordion-price-item-open" id="<?php echo get_field('accordion-price_option_title')?>">
                        <div class="accordion-price__head">
                ...
                <?php if (have_rows('price-table_accordion', 'option')): ?> <!--Остальное-->
                    <?php while (have_rows('price-table_accordion', 'option')): the_row(); ?>
                        <div class="accordion-price" id="other_<?php the_sub_field('price-table_accordion_title');?>">
                            <div class="accordion-price__head">
