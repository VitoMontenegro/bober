...
<div style="margin-bottom: 40px;">
    ...
    <table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
        ...
        <tr>
            ...
            <?php if($get_postponement && $GLOBALS['$postponement']){?>
                <th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;">Отсрочка</th>
            <?php } ?>
        </tr>
        </thead>
        <tbody>
        ...
        if ( $item_totals ) {
            ...
            foreach ( $item_totals as $total ) {
                $i++;
                if(wp_kses_post( $total['label'] ) == 'Подытог:'){
                    continue;
                }
                ?>
